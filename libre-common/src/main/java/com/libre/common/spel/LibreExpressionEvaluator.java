 ...
 * @author L.cm
 */
public class LibreExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
		...
		LibreExpressionRootObject rootObject = new LibreExpressionRootObject(method, args, target, targetClass, targetMethod);
