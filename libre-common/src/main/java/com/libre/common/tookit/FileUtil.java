package com.libre.common.tookit;
...
public class FileUtil extends org.springframework.util.FileCopyUtils {
    ...
    /**
     * Returns the path to the com.spang.system temporary directory.
     *
     * @return the path to the com.spang.system temporary directory.
     */
    ...
    /**
     * Returns a {@link File} representing the com.spang.system temporary directory.
     *
     * @return the com.spang.system temporary directory.
     */
     ...
     * Moves a file.
     * <p>
     * When the destination file is on another file com.spang.system, do a "copy and delete".
     *
