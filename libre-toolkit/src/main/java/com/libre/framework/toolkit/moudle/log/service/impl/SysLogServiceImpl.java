package com.libre.framework.toolkit.moudle.log.service.impl;

import com.baomidou.mybatisplus.core.conditions.Wrapper;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.PageDTO;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.libre.framework.toolkit.moudle.log.mapper.SysLogMapper;
	...
	private Wrapper<SysLog> getQueryWrapper(SysLogCriteria query) {
		...
		wrapper.and(StringUtil.isNotBlank(blurry),
				w -> w.like(SysLog::getUsername, blurry)
					...
					.or()
					.like(SysLog::getDescription, blurry)
					.or()
					.like(SysLog::getAddress, blurry)
					.or()
					.like(SysLog::getRequestIp, blurry)
					.or()
					.like(SysLog::getClassMethod, blurry)
					.or()
