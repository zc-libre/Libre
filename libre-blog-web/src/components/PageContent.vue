<template>
  <div class="flex flex-col">
    <div class="post-header">
      ...
      <div v-if="enableStatus" class="flex flex-row items-center justify-start mt-8">
        <PostStats
          :post-word-count="post.count.symbolsCount"
          :post-time-count="post.count.symbolsTime"
