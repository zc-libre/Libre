                  ...
                  <a href="javascript:void(0)" @click="handleLinkClick(result)">
                    <div class="search-hit-container">
                      ...
                      <div class="search-hit-content-wrapper">
                        ...
                        ></span>
                        <span class="search-hit-path" v-html='result.articleName'></span>
                      </div>
        ...
        <div class="search-footer">
          <div class="search-logo">
            ...
            >
              ...
              <img
                class="mr-1.5"
                src="https://avatars.githubusercontent.com/u/6764390?s=48&amp;v=4"
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleLinkClick = (result: SearchResultType) => {
      ...
      if (result.id !== '')
        router.push({name: 'article', params: {articleId: result.id}})
    }
    ...
    const search = async (keyWord: string) => {
      await searchStore.fetchSearchIndex(keyWord).then(() => {
