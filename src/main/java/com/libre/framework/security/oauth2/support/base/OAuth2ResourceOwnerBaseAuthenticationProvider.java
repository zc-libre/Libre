package com.libre.framework.security.oauth2.support.base;

import com.libre.boot.autoconfigure.SpringContext;
import com.libre.security.util.OAuth2ErrorCodesExpand;
import com.libre.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public OAuth2ResourceOwnerBaseAuthenticationProvider(AuthenticationManager authenticationManager,
		...
		// 国际化配置
		this.messages = new MessageSourceAccessor(SpringContext.getBean("securityMessageSource"), Locale.CHINA);
	}
