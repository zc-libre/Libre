...
import com.libre.admin.module.system.mapper.SysDeptMapper;
import com.libre.admin.module.system.param.DeptParam;
import com.libre.admin.module.system.service.SysDeptService;
import com.libre.admin.module.system.service.SysUserService;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements SysDeptService {
    ...
    @Override
    public  Page<SysDept> findByPage(DeptParam param) {
    ...
    public boolean deleteIfUnusedByIds(Collection<Long> ids) {
        ...
        if (CollectionUtil.isEmpty(userList)) {
            throw new ServiceException("存在用户岗位关系");
        }
        return super.removeByIds(ids);
    }

    private Wrapper<SysDept> getQueryWrapper(DeptParam param) {
