...
import com.libre.admin.module.system.mapper.SysUserMapper;
import com.libre.admin.module.system.param.UserParam;
import com.libre.admin.module.system.service.*;
import com.libre.admin.module.system.service.convert.SysUserConvert;
...
import static com.libre.admin.common.constant.CacheConstants.SYS_USER_CACHE;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public IPage<UserVO> findByPage(Page<SysUser> page, UserParam userParam) {
        ...
        if (CollectionUtil.isEmpty(records)) {
            return PageUtil.toPage(page, UserVO.class);
        }
    ...
    private Wrapper<SysUser> getQueryWrapper(UserParam param) {
        ...
        LambdaQueryWrapper<SysUser> wrapper = Wrappers.<SysUser>lambdaQuery()
                .nested(param.isBlurryQuery(), q -> q.like(SysUser::getEmail, blurry)
                        .or()
