...
import com.libre.framework.system.security.service.UserLockService;
...
public class LibreAuthenticationProvider extends DaoAuthenticationProvider {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		int retryLimit = securityProperties.getLogin().getRetryLimit();
	...
	protected void doAfterPropertiesSet() {
		...
		Assert.notNull(securityProperties, "dreamProperties is null");
		Assert.notNull(cacheManager, "cacheManager is null");
		String retryLimitCacheName = securityProperties.getLogin().getRetryLimitCacheName();
	...
	private UsernamePasswordAuthenticationToken decodeRsaPassword(Authentication auth) {
		UsernamePasswordAuthenticationToken newToken = (UsernamePasswordAuthenticationToken) auth;
